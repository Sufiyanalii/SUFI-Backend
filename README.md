...
You can access the live application at [https://suficart.vercel.app/](https://suficart.vercel.app/).
...
The frontend of the application is built with ReactJS, Material UI, React-router-dom,ContextAPI. The source code for the frontend can be found at [https://github.com/Sufiyanalii/MERN-E-Commerce-Frontend](https://github.com/Sufiyanalii/MERN-E-Commerce-Frontend).
